...
def main():
    # Set page config with a more descriptive title and icon
    st.set_page_config(
    ...
    with st.sidebar:
        st.title("About")
        st.markdown("""
        **Mentor Review System** helps analyze mentorship sessions 
        and provide feedback based on established guidelines.
    ...
    st.markdown("""
    Upload one or more mentorship session transcripts in JSON format 
    to generate detailed reviews based on established guidelines.
    """)
